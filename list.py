...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        root.title("HOMESTAY MANAGEMENT")
        ...
        self.Labelframe1.configure(background="beige")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#062830")
        ...
        self.Label1.configure(background="#062830")
        ...
        self.Text1.configure(foreground="#062830")
