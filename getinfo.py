    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " valid homestay number ""\n")
            else :
                self.Text1.insert(INSERT,"invalid homestay number""\n")
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        ...
                        print("\n")
                        print("TOTAL BILL IS RM.", s.price)
                    elif EOFError:
                        if n == 0:
                            print("NO GUEST IN HOMESTAY ", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Text1.configure(background="#062830")
        self.Text1.configure(font="TkTextFont")
        self.Text1.configure(foreground="beige")
        ...
        self.Label1.place(relx=0.12, rely=0.15, height=48, width=450)
        self.Label1.configure(background="beige")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font=font9)
        self.Label1.configure(foreground="#000000")
        self.Label1.configure(text='''ENTER THE HOMESTAY NO.   :''')
        ...
        self.Button1.configure(foreground="beige")
